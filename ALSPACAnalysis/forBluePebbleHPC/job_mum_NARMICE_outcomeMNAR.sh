...
#SBATCH --job-name=NARMICE_mum_outcomeMNAR
...
#SBATCH --mem=5G
#SBATCH --array=1
#SBATCH --error=/user/home/ds16565/BloodDonation/Results_mum/Error_outcomeMNAR.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/BloodDonation/Results_mum/Output_outcomeMNAR.txt # SLURM output file
...
# Run the R script
srun /user/home/ds16565/R-4.1.0/bin/Rscript /user/home/ds16565/BloodDonation/Scripts/mum_NARMICE_outcomeMNAR.r ${i}
