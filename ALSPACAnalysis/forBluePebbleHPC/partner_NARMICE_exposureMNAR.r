...
### Script 4c: Analysing partner's data using NARMICE assuming exposure is MNAR
...
## Save this table
write_csv(tipping_exposureMNAR, file = "/user/home/ds16565/BloodDonation/Results_partner/Results_partner_NARMICE_exposureMNAR.csv")
