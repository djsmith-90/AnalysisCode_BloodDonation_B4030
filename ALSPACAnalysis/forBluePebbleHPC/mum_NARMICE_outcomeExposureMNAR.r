...
seed <- c(672171, 647441, 861565, 849102, 704677, 423974, 367149, 563449, 294047)[a]
...
# Looping over delta/CSP values for outcome (i)
set.seed(seed)
k <- 0
...
## Save this table
write_csv(tipping_outcomeExposureMNAR, paste0("/user/home/ds16565/BloodDonation/Results_mum/Results_mum_NARMICE_outcomeExposureMNAR_", a, ".csv"))
